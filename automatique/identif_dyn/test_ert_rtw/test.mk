...
## 
## Makefile     : test.mk
## Generated on : Thu Apr 02 17:32:46 2026
...
START_DIR                 = $(MATLAB_WORKSPACE)/C/Users/user/Nextcloud/Documents/ensps_work/2025-2026-M1-EEA/TER/travail/automatique/identif_dyn
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2025b/toolbox/realtime/targets/raspi/unifiedserver -I$(START_DIR)/test_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2025b/toolbox/realtime/targets/raspi/include -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
OBJS = devices.c.o LED.c.o test.c.o test_data.c.o MW_raspi_init.c.o MW_Pyserver_control.c.o linuxTimeLogger.c.o linuxinitialize.c.o
...
%.cpp.o : $(START_DIR)/test_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
devices.c.o : $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2025b/toolbox/realtime/targets/raspi/unifiedserver/devices.c
	$(CC) $(CFLAGS) -o "$@" "$<"


LED.c.o : $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2025b/toolbox/realtime/targets/raspi/unifiedserver/LED.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.c.o : $(START_DIR)/test_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


test.c.o : $(START_DIR)/test_ert_rtw/test.c
	$(CC) $(CFLAGS) -o "$@" "$<"


test_data.c.o : $(START_DIR)/test_ert_rtw/test_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
